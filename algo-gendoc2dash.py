"""
    Generate Dash docset for Algorithms wikibooks
...
# CONFIGURATION
docset_name = 'algorithms-wikibooks.docset'
output = docset_name + '/Contents/Resources/Documents'
root_url = 'http://en.wikibooks.org/wiki/Algorithms'
...
def add_docs():
    ...
    for i, link in enumerate(soup.findAll('a')):
        ...
        if isinstance(path, str) and path.startswith('/wiki/Algorithms'):
            sections.append(path)
            titles.append(name)

    print len(sections), len(titles)
